"""
ABLATION A3a: NO SELF-BOOTSTRAPPING (Static Dataset)

Full ICL architecture + full curriculum training, but the dataset NEVER grows.
No unsupervised solutions are ever added. The dataset stays at its initial size
(D_0) throughout training. This proves that self-bootstrapping (dynamic dataset
enrichment) is essential for context diversity and continued performance gains.

EXPECTED RESULT: Performance plateaus once the model exhausts the diversity
of the small initial dataset. The proposed method with self-bootstrapping
...
def train(cfg):
    ...
    for epoch in range(cfg.total_epochs):
        ...
        for step in range(cfg.steps_per_epoch):
            ...
            # [A3a] NO SELF-BOOTSTRAPPING: dataset remains static at D_0.
            # No unsupervised solutions are ever admitted.
            pass
        ...
        # [A3a] No pruning needed — dataset is static, no unsupervised samples.
        nd = 0
